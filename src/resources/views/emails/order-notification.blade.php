                    ...
                    <tr>
                        <td style="padding: 32px 24px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 24px; background-color: #f9fafb; border-radius: 6px; padding: 16px;">
                                ...
                                <tr>
                                    <td style="padding: 8px 16px;">
                                        <p style="font-size: 12px; color: #6b7280; margin: 0;">購入者名</p>
                                        <p style="font-size: 14px; color: #1f2937; margin: 4px 0 0;">{{ $order->user->name }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 16px;">
                            ...
                            {{-- 商品明細 --}}
                            <h2 style="font-size: 16px; color: #1f2937; margin: 0 0 12px; border-bottom: 2px solid #e5e7eb; padding-bottom: 8px;">注文商品</h2>
